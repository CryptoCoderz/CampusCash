...
void TransactionView::changedAmount(const QString &amount)
{
    ...
    // Replace "," by "." so CampusCashUnits::parse will not fail for users entering "," as decimal separator
    QString newAmount = amount;
    newAmount.replace(QString(","), QString("."));

    if(CampusCashUnits::parse(model->getOptionsModel()->getDisplayUnit(), newAmount, &amount_parsed))
    {
...
void TransactionView::exportClicked()
{
    ...
    writer.addColumn(CampusCashUnits::getAmountColumnTitle(model->getOptionsModel()->getDisplayUnit()), 0, TransactionTableModel::FormattedAmountRole);
...
void TransactionView::computeSum()
{
    ...
    QString strAmount(CampusCashUnits::formatWithUnit(nDisplayUnit, amount, true, CampusCashUnits::separatorAlways));
